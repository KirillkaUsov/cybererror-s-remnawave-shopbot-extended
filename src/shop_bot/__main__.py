...
def main():
    ...
    class LoggerNameFilter(logging.Filter):
        """Разводит записи по файлам: бот отдельно, веб-апп отдельно."""
    ...
    WEBAPP_LOGGERS = ('uvicorn.', 'shop_bot.webapp')
    ...
    fh.addFilter(LoggerNameFilter(WEBAPP_LOGGERS, include=False))
    root.addHandler(fh)
    ...
    webapp_fh.addFilter(LoggerNameFilter(WEBAPP_LOGGERS, include=True))
