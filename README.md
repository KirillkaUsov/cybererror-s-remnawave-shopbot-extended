...
Скриптов-установщиков здесь нет: они предполагали чистый сервер и разворачивали Docker, Nginx и Certbot с нуля. 

**К сожалению можно установить только с нуля** — пока обновиться с оригинального бота не получится:
