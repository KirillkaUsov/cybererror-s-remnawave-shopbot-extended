...
Дни не падают куда попало и не пропадают, если подписки ещё нет: приз ложится в историю кабинета и ждёт там владельца. Забрать его можно в течение 14 дней (срок настраивается), выбрав подписку, к которой он добавится. В кабинете видно всё: что выпало, что забрано и что сгорело.
