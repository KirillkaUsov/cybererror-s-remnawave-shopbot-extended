...
Сектор даёт дни к подписке, рубли на баланс, персональный купон на скидку или ничего. Купон создаётся одноразовым, с датой сгорания и подписью, кому и за какой сектор он выдан. Дни не падают куда попало: если подписок несколько, приз ждёт в отдельном состоянии, пока владелец не выберет, куда его зачислить — закрытая вкладка выигрыш не съедает.
